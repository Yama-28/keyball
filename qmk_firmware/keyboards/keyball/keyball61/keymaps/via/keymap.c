...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LEFT_ALT,    KC_LEFT_GUI,    KC_LEFT_CTRL,   KC_LEFT_ALT, LT(1,KC_LANGUAGE_2), LT(2,KC_SPACE),  LT(3,KC_LANGUAGE_1), LT(2,KC_BACKSPACE), LT(1,KC_ENT),   _______,     _______,          _______,      KC_RALT,               QK_KB_10
  ),
  ...
  [3] = LAYOUT_universal(
    ...
    KC_TRANSPARENT, KC_NO,          RGB_SAD,        RGB_HUD,        RGB_VAD,          RGB_MODE_REVERSE, KC_TRANSPARENT,     RCS(KC_ESCAPE),     QK_KB_5,        QK_KB_3,     QK_KB_9,          QK_KB_12,     KC_NO,                KC_NO,
