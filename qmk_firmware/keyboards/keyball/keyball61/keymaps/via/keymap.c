...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LEFT_ALT,    KC_LEFT_GUI,    KC_LEFT_CTRL,   KC_LEFT_ALT, CTL_T(KC_LANGUAGE_2), LT(2,KC_SPACE),  LT(3,KC_LANGUAGE_1),   LT(2,KC_BACKSPACE),  LT(1,KC_ENT),   _______,     _______,          _______,      TG(2),                 QK_KB_6
  ),

  [1] = LAYOUT_universal(
    KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,       KC_NO,               KC_NO,                                                       KC_NO,          KC_NO,       KC_NO,            KC_NO,        KC_NO,                 KC_BSPC,
    ...
    KC_TRANSPARENT, KC_LEFT_GUI,    KC_LEFT_CTRL,   KC_LEFT_ALT, KC_TRANSPARENT,      KC_TRANSPARENT,  KC_TRANSPARENT,        KC_BACKSPACE,        KC_ENTER,       _______,     _______,          _______,      QK_KB_10,              KC_TRANSPARENT
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,   KC_TRANSPARENT,  KC_TRANSPARENT,        KC_DELETE,           KC_ENTER,       _______,     _______,          _______,      TG(2),                KC_TRANSPARENT
  ),
  ...
  [3] = LAYOUT_universal(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,   KC_TRANSPARENT,   KC_TRANSPARENT,       LCA(KC_DELETE),      KC_ENTER,       _______,     _______,          _______,      KC_NO,                RCS(KC_ESCAPE)
  ),
};
// clang-format on
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    switch (layer) {
      ...
      case 1:
        ...
        rgblight_sethsv(240, 100, 50);
        break;
      case 2:
        //rgblight_sethsv(HSV_RED);
        rgblight_sethsv(0, 100, 50);
        break;
      case 3:
        //rgblight_sethsv(HSV_GREEN);
        rgblight_sethsv(120, 100, 50);
        break;
    }
