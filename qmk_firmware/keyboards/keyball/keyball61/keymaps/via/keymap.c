...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,        KC_V,                KC_B,            LT(3,KC_ESCAPE),     LT(3,KC_PRINT_SCREEN), KC_N,           KC_M,        KC_COMMA,        KC_DOT,        KC_SLASH,              KC_INTERNATIONAL_1,
    KC_LEFT_ALT,    KC_LEFT_GUI,    KC_LEFT_CTRL,   KC_LEFT_ALT, LT(1,KC_LANGUAGE_2), LT(2,KC_SPACE),  LT(1,KC_LANGUAGE_1), LT(2,KC_BACKSPACE),    LT(1,KC_ENT),   _______,     _______,          _______,      KC_RALT,               QK_KB_10
  ),

  [1] = LAYOUT_universal(
    KC_TRANSPARENT, KC_F1,          KC_F2,          KC_F3,       KC_F4,               KC_F5,                                                       KC_F6,          KC_F7,       KC_F8,            KC_F9,        KC_F10,                KC_F11,
    KC_TRANSPARENT, S(KC_1),        S(KC_2),        S(KC_3),     S(KC_4),             S(KC_5),                                                     S(KC_6),        S(KC_7),     S(KC_8),          S(KC_9),      S(KC_INTERNATIONAL_3), KC_F12,
  ...
  [3] = LAYOUT_universal(
    LCA(KC_ESCAPE), KC_NO,          KC_NO,          KC_NO,          KC_NO,            KC_NO,                                                      KC_NO,          KC_NO,       KC_NO,            KC_NO,        KC_NO,                KC_NO,
